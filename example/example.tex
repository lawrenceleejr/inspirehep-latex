...
\section*{These papers, taken together}

An INSPIRE profile covers everything with your name on it, which in a large
collaboration is mostly papers you had no hand in. A collection covers the
papers this document actually lists --- \inspirecollectionpapers{} of them,
\inspirecollectioncitations{} citations, $h$-index \inspirecollectionhindex{},
$g$-index \inspirecollectiongindex{} --- and \inspirecollectionlink{one INSPIRE search}
finds exactly those, so a reader can check the figures rather than take them.

Their citations per year, counting each citing paper once:

\inspirecollectionplot
